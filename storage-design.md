...
- Use Cloud Object Storage to store logs and backups. Cloud Object Storage is highly available, durable, and secure and provides region and cross-region [resiliency options](/docs/cloud-object-storage?topic=cloud-object-storage-endpoints). Use region Cloud Object Storage buckets for logs and cross-region Cloud Object Storage buckets for backups.
