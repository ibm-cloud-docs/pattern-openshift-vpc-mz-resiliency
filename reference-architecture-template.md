...
# Set to true to publish reference architecture to IBM Cloud Docs 
production: false
...
Update Table below with requirements for this architecture. Introduce the table with a sentence. For example: "The following table outlines the requirements addressed in this architecture."
...
Update Table below with components unique to this architecture. Introduce the table with a sentence. For example: "The following table outlines the products or services used in the architecture for each aspect."
...
:exclamation: **Important:** We recommend that you rename this file `<architecture-name>.md`. In the case of deployable architectures, `<architecture-name>` is the same as the deployable architecture name.
